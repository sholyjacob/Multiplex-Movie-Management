...
import actor.SocketActorMultiplex;
...
public class SocketControllerMultiplex  extends Controller {
        ...
        return ActorFlow.actorRef(guardianActorRef->{
            return SocketActorMultiplex.init(guardianActorRef);
        ...
        String url = routes.SocketControllerMultiplex.socket().webSocketURL(request);
        ...
        return ok(views.html.search.multiplexSearch.render(url));
